namespace Infrastructure.Events.Pod;

public class PodEntityCreatedIntegrationEventHandler(IProducer<Ignore, IIntegrationEvent> producer) : IEventHandler<PodEntityCreatedIntegrationEvent>
{
    ...
    public async Task Handle(PodEntityCreatedIntegrationEvent notification, CancellationToken ct = default)
    {
